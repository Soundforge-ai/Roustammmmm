          ...
          {testimonials.length > 1 && (
            <>
              <button
                ...
                className="absolute left-0 top-1/2 -translate-y-1/2 -translate-x-4 md:-translate-x-12 p-3 bg-white rounded-full shadow-lg hover:bg-gray-50 transition-colors"
              ...
              <button
                onClick={goToNext}
                className="absolute right-0 top-1/2 -translate-y-1/2 translate-x-4 md:translate-x-12 p-3 bg-white rounded-full shadow-lg hover:bg-gray-50 transition-colors"
