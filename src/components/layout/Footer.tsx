...
const Footer: React.FC<FooterProps> = ({ onAdminClick }) => {
  ...
  return (
    <footer className="bg-brand-dark text-slate-300 py-8 sm:py-12 border-t border-slate-800">
      <div className="container mx-auto px-4 sm:px-6">
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8 sm:gap-12 mb-8 sm:mb-12">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li className="text-slate-400">Zoersel<br />De Beemdekens 39<br />2980 Zoersel, België</li>
            </ul>
        ...
        <div className="border-t border-slate-800 pt-6 sm:pt-8 flex flex-col sm:flex-row justify-between items-center gap-4 text-xs text-slate-500">
