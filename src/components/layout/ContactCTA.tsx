...
const ContactCTA: React.FC<ContactCTAProps> = ({ onSubmitLead }) => {
  ...
  const inputClasses = (fieldName: keyof FormErrors) =>
    `w-full px-4 py-3 rounded-md border transition-all focus:outline-none ${errors[fieldName]
    ...
    <section id="contact" className="py-12 sm:py-20 bg-gray-50">
      <div className="container mx-auto px-4 sm:px-6">
        <div className="bg-white rounded-2xl shadow-xl overflow-hidden flex flex-col lg:flex-row">
          <div className="lg:w-3/5 p-6 sm:p-10 lg:p-16 flex flex-col justify-center">
            <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-brand-dark mb-4">
              Zin om uw plannen te bespreken?
            </h2>
            <p className="text-gray-600 text-base sm:text-lg mb-6 sm:mb-8">
              Vertel ons kort wat u nodig heeft. We denken met u mee, geven eerlijk advies en bezorgen een duidelijke, vrijblijvende offerte.
            </p>
            ...
            {submitted ? (
              <div className="bg-green-50 border border-green-200 rounded-lg p-8 text-center" role="alert">
                ...
                <h3 className="text-xl font-bold text-green-800 mb-2">Bedankt! We hebben uw aanvraag goed ontvangen.</h3>
                <p className="text-green-700">We nemen snel contact op om uw project rustig te overlopen.</p>
              </div>
            ) : (
              <form className="space-y-4" onSubmit={handleSubmit} noValidate>
                ...
                <div>
                  ...
                  <textarea
                    ...
                    onChange={handleChange}
                    placeholder="Waarmee kunnen we u helpen? (bv. ramen vervangen, gevelisolatie, renovatie...) *"
                ...
                >
                  {isSubmitting ? (
                    ...
                    'Vraag mijn vrijblijvende offerte'
                  )}
                </button>
              </form>
            )}
          ...
          <div className="lg:w-2/5 bg-brand-primary p-6 sm:p-10 lg:p-16 text-white flex flex-col justify-between relative overflow-hidden">
            ...
            <div className="relative z-10">
              ...
              <address className="space-y-6 not-italic">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <p className="font-semibold">Kantoor</p>
            ...
            <p className="relative z-10 mt-12 text-sm text-gray-400">
              We werken vooral in Antwerpen, Mechelen en de Kempen — en komen graag bij u langs voor opmeting en advies.
            </p>
          </div>
        </div>
      </div>
