...
const QuoteCalculator: React.FC<QuoteCalculatorProps> = ({ onRequestQuote }) => {
  ...
  const handleCalculate = () => {
    ...
    if (!projectType) {
      setError('Kies eerst het type project, dan kunnen we een indicatie berekenen.');
      return;
    }
    ...
    try {
      ...
      setError('Er ging iets mis bij de berekening. Probeer het gerust opnieuw.');
    }
  };
      ...
      <div className="container mx-auto px-4 sm:px-6">
        <div className="max-w-2xl mx-auto">
          <div className="text-center mb-8 sm:mb-10">
            <div className="inline-flex items-center justify-center w-12 h-12 sm:w-16 sm:h-16 bg-brand-accent/10 rounded-full mb-4">
              <Calculator className="text-brand-accent w-6 h-6 sm:w-8 sm:h-8" />
            </div>
