...
const Diensten: React.FC = () => {
  const allServices = [
    ...
    },
    {
      ...
      link: '/crepi-info', // Or /gevel if that exists as main hub, checking usage usually suggests crepi-info or gevel
      icon: Home,
    ...
    },
    {
      ...
      link: '/gevel/gevelisolatie', // Assuming this fits best under gevel or separate
      icon: ThermometerSun,
  ...
  return (
    <>
      <Helmet>
        <title>Onze Diensten | Renovatie, Ramen, Tuin & Meer | Yannova</title>
        <meta name="description" content="Ontdek het complete dienstenpakket van Yannova. Van ramen en deuren tot totaalrenovatie, gevelwerken, tuinaanleg en schilderwerken. Uw partner in Zoersel." />
      </Helmet>
